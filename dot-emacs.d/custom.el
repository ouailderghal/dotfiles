(custom-set-variables
 ...
 '(package-selected-packages
   '(nix-mode yaml-mode vertico tuareg terraform-mode smex projectile-ripgrep pkl-mode php-mode org-superstar orderless mu4e-alert modus-themes markdown-mode marginalia magit json-mode ivy indent-guide gruvbox-theme go-mode evil-surround evil-mu4e evil-collection doom-themes dockerfile-mode docker company ansible activities)))
(custom-set-faces
