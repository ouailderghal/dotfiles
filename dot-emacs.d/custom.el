(custom-set-variables
 ...
 '(package-selected-packages
   '(ansible yaml-mode vertico tuareg terraform-mode projectile-ripgrep pkl-mode php-mode org-superstar orderless markdown-mode marginalia magit json-mode ivy indent-guide gruvbox-theme go-mode f evil-surround evil-collection doom-themes dockerfile-mode company activities)))
(custom-set-faces
