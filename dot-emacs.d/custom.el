(custom-set-variables
 ...
 '(package-selected-packages
   '(docker yaml-mode vertico tuareg terraform-mode projectile-ripgrep pkl-mode php-mode org-superstar orderless markdown-mode marginalia magit json-mode ivy indent-guide gruvbox-theme go-mode evil-surround evil-collection doom-themes dockerfile-mode company ansible activities)))
(custom-set-faces
