...
* Helper functions
** Open [[https://st.suckless.org/][simple terminal]]
Helper functions to open the =simple terminal= in default directory or in home directory. Make sure that you have [[http://st.suckless.org/patches/workingdir/][workingdir patch]] applied to your [[https://github.com/ouailderghal/st][st build]].
